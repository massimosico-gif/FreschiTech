  ...
  if (viewMode === 'detail') {
    ...
    return (
      <div className="space-y-8">
        ...
        {createPortal(
          <AnimatePresence>
            {duplicateModal.isOpen && duplicateModal.existingItem && duplicateModal.newItem && (
              <div className="fixed inset-0 z-[9999] flex items-center justify-center p-6">
                ...
                <motion.div
                  ...
                  className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl rounded-[2.5rem] border border-white/50 shadow-2xl overflow-hidden p-8 space-y-6"
                >
