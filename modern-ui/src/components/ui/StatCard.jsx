  ...
  <Card className="p-5 sm:p-6 hover:bg-accent hover:text-white group transition-all duration-500 overflow-hidden">
    <div className="flex items-start justify-between gap-3">
      <div className="space-y-1.5 min-w-0 flex-1">
        <p className="text-[0.72rem] sm:text-[0.75rem] font-black uppercase tracking-[0.15em] text-slate-400 group-hover:text-white/70 transition-colors leading-relaxed break-words">{label}</p>
        ...
        {trend && (
          <p className={`text-[0.7rem] sm:text-[0.72rem] font-bold ${trend > 0 ? 'text-green-500' : 'text-rose-500'} group-hover:text-white`}>
